...
namespace Wavefront.CSharp.SDK.Entities.Histograms
{
    ...
    public interface IWavefrontHistogramSender
    {
        ...
        /// </summary>
        /// <param name="name">
        /// The name of the histogram distribution. Spaces are replaced with '-' (dashes) and
        ...
        /// <see cref="KeyValuePair{double, int}"/> where the first dimension is the mean
        /// value(Double) of the centroid and second dimension is the count of points in that
        /// centroid.
        /// </param>
